      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          <div class="d-inline-block">
              ...
              <?= trans('add_new_insurance_company') ?> </h3>
          </div>
            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php echo form_open(base_url('admin/insurance_company/add'), 'class="form-horizontal needs-validation" novalidate="novalidate"');  ?> 
                  <div class="row">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="submit" name="submit" value="<?= trans('add_insurance_company') ?>" class="btn btn-primary pull-right">
                    </div>
                  </div>
                  <?php echo form_close(); ?>
                </div>
