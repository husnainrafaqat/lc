      ...
      <div class="card card-default">
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('admin/admin_roles/module_form_field_edit'), 'class="form-horizontal needs-validation" novalidate="novalidate"');  ?> 
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="col-md-12">
                  <input type="text" name="field_name" class="form-control" required value="<?=$field_date['name']?>" id="field_name" placeholder="">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="col-md-12">
                  <input type="number" name="is_required" class="form-control" value="<?=$field_date['is_required']?>" id="is_required" required placeholder="">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="col-md-12">
                  <input type="number" name="sort_order" class="form-control" value="<?=$field_date['sort_order']?>" id="sort_order" required placeholder="">                  
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <input type="submit" name="submit" value="<?= trans('update_form_field') ?>" class="btn btn-primary pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
        </div>
