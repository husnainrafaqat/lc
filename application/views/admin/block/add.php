            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php echo form_open(base_url('admin/block/add'), 'class="form-horizontal"');  ?> 
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="submit" name="submit" value="<?= trans('add_block') ?>" class="btn btn-primary pull-right">
                    </div>
                  </div>
                  <?php echo form_close(); ?>
                </div>
