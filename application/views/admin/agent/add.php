            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php echo form_open(base_url('admin/agent/add'), 'class="form-horizontal needs-validation" novalidate="novalidate"');  ?> 
                  <div class="row">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <input type="submit" name="submit" value="<?= trans('add_agent') ?>" class="btn btn-primary pull-right">
                    </div>
                  </div>
                  <?php echo form_close(); ?>
                </div>
