  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav">
      ...
      <!--<li class="nav-item d-none d-sm-inline-block">
        <a href="<?php //echo base_url('admin') ?>" class="nav-link"><?= trans('home') ?></a>
      </li>
       <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link"><?php //echo trans('contact') ?></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php //echo base_url('admin/auth/logout') ?>" class="nav-link"><?= trans('logout') ?></a>
      </li> -->
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" style="font-size:30px;top:-10px;" data-toggle="dropdown" href="#" title="Profile">
          <i class="fa fa-user-circle"></i>          
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <a href="<?= base_url('admin/auth/logout') ?>" class="nav-link"  class="dropdown-item"><i class="fa fa-sign-out mr-2"></i> <?= trans('logout') ?></a>  
          <div class="dropdown-divider"></div>          
        <a href="<?= base_url('admin/profile/') ?>" class="nav-link"  class="dropdown-item"><i class="fa fa-eye mr-2"></i> <?= trans('view_profile') ?></a>   
          <div class="dropdown-divider"></div>          
          <a href="<?= base_url('admin/profile/change_pwd/') ?>" class="nav-link"  class="dropdown-item"><i class="fa fa-gear mr-2"></i> <?= trans('change_password') ?></a>   
          <div class="dropdown-divider"></div>            
      </li>
      <!-- Languages -->
      <?php /* ?><?php  $languages = get_language_list(); ?>
      <li class="nav-item dropdown">
